...
Protocol.prototype.sslconnect = function(cb) {  
  return this._enqueue(new Sequences.SSLConnect(options, cb));;
};
...
Protocol.prototype._parsePacket = function() {
  ...
  if ([Packets.HandshakeInitializationPacket,Packets.SSLHandshakeInitializationPacket].indexOf(Packet) > -1) {
...
Protocol.prototype._determinePacket = function(sequence, ssl) {
  ...
  switch (firstByte) {
    case 0x00:
      if(ssl && !this._encrypted) {
        this._encrypted = true;
        this.emit('sslencrypted');
        break; // break out as handshake needs to occur still
      }
      if (!this._handshaked) {
